...
const StudentFormPage = () => {
  ...
  const nextStep = () => {
    ...
    if (
      ...
      (!formData.examName || !formData.examScore)
    ) {
      return toast.error("Please enter the examination and score");
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.appearedForExam === "Yes" && !files.scoreCard) {
      return toast.error("Please upload your entrance examination scorecard");
    }
    if (formData.appearedForExam !== "Yes" && !files.hallTicket) {
      return toast.error("Please upload your hall ticket or admit card");
    }
    try {
      setLoading(true);
    ...
    return (
      <div className="form-page">
        <div className="form-container card success-container">
          ...
          <p className="text-xl font-semibold text-accent-teal mb-4">
            Application ID: {applicationId}
          </p>
          <p className="text-text-secondary mb-8">
            Thank you for updating your higher education details. The HEC cell
        ...
        <form onSubmit={handleSubmit} className="mt-8">
            ...
            <div className="form-grid animate-fadeIn">
              <div className="form-group">
                ...
                <input
                  ...
                  className="input"
                  name="tu4fId"
                  value={formData.tu4fId}
                  onChange={handleInputChange}
                  required
                  placeholder="e.g. TU4F2021001"
                />
              </div>
              <div className="form-group">
          ...
          {step === 2 && (
            <div className="form-grid animate-fadeIn">
              <div className="form-group form-grid-full">
                ...
                <select
                  className="select"
                  name="pursuingHigherEd"
                  value={formData.pursuingHigherEd}
                  onChange={handleInputChange}
                >
              ...
              {formData.pursuingHigherEd === "Yes" && (
                <>
                  ...
                  <div className="form-group form-grid-full">
                    <label className="form-label">
                      Institute Admitted To (if applicable)
                    </label>
                    <input
                      type="text"
                      className="input"
                      name="instituteAdmitted"
                      value={formData.instituteAdmitted}
                      onChange={handleInputChange}
          ...
          {step === 3 && (
            <div className="form-grid animate-fadeIn">
              <div className="form-group form-grid-full">
                <label className="form-label">
                  Have you appeared for any entrance exam?
                </label>
                <select
                  className="select"
                  name="appearedForExam"
                  value={formData.appearedForExam}
                  onChange={handleInputChange}
                >
                  <option value="Yes">Yes</option>
                  <option value="No">No</option>
          ...
          {step === 4 && (
            <div className="form-grid animate-fadeIn">
              ...
              <div className="form-group form-grid-full">
                <FileUpload
                  label="Marksheet / Transcript (Optional)"
                  name="transcript"
                  accept=".pdf,.jpg,.jpeg,.png,.doc,.docx"
              ...
              <div className="form-group form-grid-full">
                <FileUpload
                  label="Additional Marksheet (Optional)"
                  name="marksheet"
                  accept=".pdf,.jpg,.jpeg,.png,.doc,.docx"
                  value={files.marksheet}
                  onChange={handleFileChange}
                />
              </div>
              <div className="form-group form-grid-full">
                <FileUpload
                  ...
                  name="otherDocs"
                  accept=".pdf,.jpg,.jpeg,.png,.doc,.docx"
                  value={files.otherDocs}
                  onChange={handleFileChange}
                />
              </div>

              <div className="form-group form-grid-full">
                <h3 className="text-lg font-heading mb-4 mt-6">
                  Review Information
                </h3>
                <div className="review-section">
                  ...
                  <div className="review-item">
                    <span className="review-label">TU4F ID:</span>
                    <span className="review-value">{formData.tu4fId}</span>
                  </div>
                  <div className="review-item">
                  ...
                  <div className="review-item">
                    <span className="review-label">Pursuing Higher Ed:</span>
                    <span className="review-value">
                      {formData.pursuingHigherEd}
                    </span>
                  </div>
                  {formData.pursuingHigherEd === "Yes" && (
                    <div className="review-item">
                  ...
                  <div className="review-item">
                    <span className="review-label">Exam:</span>
                    <span className="review-value">
